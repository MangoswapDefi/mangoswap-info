...
export const ButtonLight = styled(Base)`
  background-color: ${({ color, theme }) => (color ? transparentize(0.9, color) : transparentize(0.9, theme.orange))};
  color: ${({ color, theme }) => (color ? darken(0.1, color) : theme.orange)};
  ...
  :hover {
    background-color: ${({ color, theme }) =>
      color ? transparentize(0.8, color) : transparentize(0.8, theme.orange)};
  }
`
...
export const ButtonDark = styled(Base)`
  background-color: ${({ color, theme }) => (color ? color : theme.orange)};
  color: white;
  width: fit-content;
  border-radius: 12px;
  white-space: nowrap;
  ...
  :hover {
    background-color: ${({ color, theme }) => (color ? darken(0.1, color) : darken(0.1, theme.orange))};
  }
`
